...
export default function ProposalPage() {
  ...
  const [locationOpenings, setLocationOpenings] = useState(40);
  const [membersAcquired, setMembersAcquired] = useState(100);
  const [monthlyValue, setMonthlyValue] = useState(300);
  const [lifetimeMonths, setLifetimeMonths] = useState(12);

  // Membership mix sliders
  const [twoXMembers, setTwoXMembers] = useState(50);
  const [eightXMembers, setEightXMembers] = useState(100);
  ...
  return (
    <div className="min-h-screen pb-24 bg-[#0a0a0a] text-white font-sans selection:bg-[#00A7B5] selection:text-white">
      ...
      <section className="relative pt-24 pb-20 px-6 max-w-7xl mx-auto" data-testid="section-hero">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-neutral-800 bg-neutral-900/80 text-sm font-semibold mb-8" data-testid="badge-executive-briefing">
            ...
            <span className="text-gray-300 tracking-wide">HOUNDS TOWN USA x REVRYZE</span>
          </div>
          <h1 className="text-5xl md:text-8xl font-black mb-6 tracking-tighter leading-[0.9] font-heading" data-testid="text-hero-title">
            FILL YOUR PACK.<br />
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <Card className="relative bg-neutral-900 border-neutral-800 group hover:border-red-500/30" data-testid="card-boulder-reality">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-bold mb-6" data-testid="text-boulder-tagline">"Empty Kennels on Opening Day."</p>
          ...
          <Card className="relative bg-neutral-900/50 border-[#00A7B5]/30 group" data-testid="card-revryze-standard">
            <div className="absolute top-4 right-4 opacity-20">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-bold mb-6" data-testid="text-revryze-tagline">"A Full Pack. Day One."</p>
              <ul className="space-y-4 text-sm text-gray-400">
      ...
      <section className="py-20 px-6 bg-neutral-950 border-t border-neutral-900" data-testid="section-membership">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 font-heading" data-testid="text-membership-title">Join the Pack.</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto" data-testid="text-membership-subtitle">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            {/* 2x Per Month Plan */}
            <Card className="relative bg-neutral-900 border-neutral-800 overflow-hidden group hover:border-[#6BD0E0]/40 transition-all" data-testid="card-2x-plan">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">2x Per Month</h3>
                    <p className="text-gray-500 text-sm">Casual Pack Member</p>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-neutral-800">
                  <p className="text-xs text-gray-500">Visits redeemable for daycare only. Boarding at discounted member rate.</p>
                </div>
              </CardContent>
            </Card>

            {/* 8x Per Month Plan */}
            <Card className="relative bg-neutral-900 border-[#00A7B5]/30 overflow-hidden group hover:border-[#00A7B5]/60 transition-all" data-testid="card-8x-plan">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">8x Per Month</h3>
                    <p className="text-gray-500 text-sm">Full Pack Member</p>
                  </div>
                </div>
                ...
                <div className="mb-6 space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-[#00A7B5]/10 border border-[#00A7B5]/20">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-white">First 50 Members</span>
                    </div>
                    <span className="text-2xl font-black text-[#A7D934]">$349<span className="text-sm font-normal text-gray-500">/mo</span></span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-neutral-800/50 border border-neutral-700/50">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-white">Next 50 Members</span>
                    </div>
                    <span className="text-2xl font-black text-white">$369<span className="text-sm font-normal text-gray-500">/mo</span></span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-neutral-800/50 border border-neutral-700/50">
                    ...
                    <span className="text-2xl font-black text-white">$389<span className="text-sm font-normal text-gray-500">/mo</span></span>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-neutral-800">
                  <p className="text-xs text-gray-500">Visits redeemable for daycare only. Tiered pricing rewards early joiners during prelaunch.</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-12 max-w-5xl mx-auto">
            <div className="bg-neutral-900/50 rounded-2xl border border-neutral-800 p-8" data-testid="card-membership-calculator">
              <h3 className="text-center text-lg font-bold text-white mb-2">Prelaunch Membership Revenue Preview</h3>
              <p className="text-center text-sm text-gray-500 mb-8">Adjust the mix to see projected monthly recurring revenue per location.</p>
      ...
      <section className="py-12 px-6 bg-neutral-950" data-testid="section-calculator">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 font-heading" data-testid="text-calculator-title">Per-Location ROI. Proven at Scale.</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto" data-testid="text-calculator-subtitle">Each location is its own investment. See the numbers.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <Card className="bg-neutral-900 border-neutral-800 border-l-4 border-l-[#00A7B5]" data-testid="card-slider-studios">
                <CardContent className="p-5">
                  <div className="flex justify-between items-center mb-3 gap-4 flex-wrap">
                    ...
                    <span className="text-2xl font-black text-white" data-testid="text-studios-value">{locationOpenings}</span>
                  </div>
                  <input
                    type="range"
                    min="1"
                  ...
                  />
                  {isVolumeDiscount && (
                    <p className="text-xs text-[#00A7B5] mt-2 font-semibold">10+ locations: $30,000/location</p>
                  )}
                </CardContent>
              </Card>
            ...
            <div className="lg:col-span-7 flex flex-col gap-5">
              ...
              <Card className="border-[#00A7B5]/30 bg-neutral-900 relative overflow-hidden" data-testid="card-studio-roi">
              ...
              <Card className="flex-1 border-neutral-800 bg-neutral-900/80 relative overflow-hidden" data-testid="card-royalty-output">
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center p-4 bg-neutral-800/50 rounded-xl">
                      <div className="text-gray-500 text-xs font-bold uppercase mb-2">Royalty per Location</div>
                    ...
                    <div className="text-center p-4 bg-[#00A7B5]/10 rounded-xl border border-[#00A7B5]/20">
                      ...
                      <p className="text-xs text-gray-500 mt-1">{locationOpenings} locations</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 px-4 bg-neutral-900/30 border-t border-neutral-900" data-testid="section-proof">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 font-heading" data-testid="text-proof-title">Real Results. Real Calls.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a href="/swet-call-to-share.wav" target="_blank" rel="noopener noreferrer" className="group" data-testid="link-listen-call">
              <Card className="h-full bg-neutral-900 border-neutral-800 group-hover:bg-neutral-800 transition-all hover:-translate-y-1 hover:border-[#00A7B5]/50">
                <CardContent className="p-6 flex flex-col items-center text-center h-full">
                  <div className="w-16 h-16 bg-neutral-800 rounded-full flex items-center justify-center mb-6 text-[#00A7B5] group-hover:scale-110 transition-transform">
                    <PhoneCall size={32} />
                  </div>
            ...
            <a href="/attached_assets/Swet-Studio-Recovery-Relaunch-2025.pdf" target="_blank" rel="noopener noreferrer" className="group" data-testid="link-swet-case">
              <Card className="h-full bg-neutral-900 border-neutral-800 group-hover:bg-neutral-800 transition-all hover:-translate-y-1 hover:border-[#00A7B5]/50">
                <CardContent className="p-6 flex flex-col items-center text-center h-full">
                  ...
                  <h4 className="text-xl font-bold mb-2" data-testid="text-swet-title">Presale Case Study</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="bg-neutral-900 p-8 rounded-3xl shadow-2xl flex flex-col text-white ring-4 ring-white/20" data-testid="card-volume-pricing">
              <div className="mb-6">
                ...
                <h3 className="text-4xl font-black mt-4 mb-1 text-[#A7D934]" data-testid="text-volume-price">$30,000</h3>
              ...
              <div className="mt-auto space-y-3 text-sm text-gray-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>25% savings per location</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-[#A7D934]" />
      ...
      <footer className="py-12 border-t border-neutral-900 text-center px-4" data-testid="section-footer">
        ...
        <p className="text-gray-700 text-xs" data-testid="text-footer-confidential">Proprietary and Confidential. Hounds Town USA HQ Leadership Only.</p>
      </footer>
    </div>
  );
}
